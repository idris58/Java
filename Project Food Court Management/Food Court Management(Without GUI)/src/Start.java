...
public class Start{
	...
	public static void main(String args[]) {
		...
		FileReadWriteDemo file_read = new FileReadWriteDemo();
					...
					case 1:
						...
						switch (choice1) {
							case 1:
								...
								if (f.CheckEmployeesId(empId1) == false) {
									if (f.insertEmployee(e1)) {
										System.out.println("Employee Inserted Successfully.");
										System.out.print("Name " + name1 + ",  Id " + empId1);
									}
								} else {
									System.out.println("Employee can not be created now"
											+ "\n Try again With Another ID later");
								}
								...
								if (f.searchRestaurant(rid3) != null) {
									...
									switch (choice31) {
										case 1:
											...
											if (f.searchRestaurant(rid3).CheckFoodItem(fid31)) {
										...
										case 2:
											...
											if (f.searchRestaurant(rid3).CheckFoodItem(fid32) == false) {
									...
									System.out.println("Food Id does not match. Try again.");
								}
								...
								if (f.searchRestaurant(rid411) != null) {
									...
									if (f.searchRestaurant(rid411).searchFoodItem(fid411) != null) {
										...
										if (f.searchRestaurant(rid411).searchFoodItem(fid411).addQuantity(amount1)) {
											...
											file_read.writeInFile("Amount : " + amount1 + "  added in " + fid411 + " by " + rid411);
										} else {
									...
									System.out.println("Restaurant ID  does not MISMATCH");
								}
								System.out.println("\n#######################################################\n");
								...
								if (f.searchRestaurant(rid412) != null) {
									...
									if (f.searchRestaurant(rid412).searchFoodItem(fid412) != null) {
										...
										if (f.searchRestaurant(rid412).searchFoodItem(fid412).sellQuantity(amount2)) {
											...
											file_read.writeInFile("Amount : " + amount2 + "Selled in " + fid412 + " by " + rid412);
										} else {
											System.out.println("Can Not Selled");
										}
									} else {
										System.out.println("Invalid Food Item Id Number");
									}
